...
// import dataScienceImg from "../../assets/images/ai1.png";
...
import React, { Component } from "react";
import dataScienceImg from "../../assets/images/ai1.png"; // use your image path
  ...
  render() {
    return (
      <div style={{ textAlign: "center" }}>
        <img
          src={dataScienceImg}
          alt="AI and LangChain Illustration"
          style={{
            width: "90%", // adjust size if needed (e.g. "660px")
            height: "50%",
            display: "block",
            margin: "0 auto",
            boxShadow: "none",   // no shadow
            filter: "none",       // remove drop-shadow filters
